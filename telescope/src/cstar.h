...
public:
    ...
    double GetMeanLST(double mjdd, double lontude);
     ...
     * 公元历对应的儒略日
     */
    double JulianDay(int yea, int mont, int da, double hou);
     ...
     * \return 以弧度为单位的平恒星时
     */
    double GetGMST0(const double mjdd);
     ...
     *  毫巴: 100帕
     */
    double RefractReal(double vAlt,  double pressur,  double temperatur);
     ...
     *  毫巴: 100帕
     */
    double RefractVisual(const double vAlt, const double pressur, const double temperatur);
